...
@pytest.mark.skipif(
    not sr.Microphone.list_microphone_names(), reason="No microphone available"
)
...
@pytest.mark.skipif(
    os.getenv("OPENAI_API_KEY") is None or os.getenv("OPENAI_API_KEY") == "",
    reason="Needs valid OpenAI API key",
)
